			          ...
			          <div className="col-lg-4 col-md-6">
			            <div className="single-product-wrap style-bottom">
			              ...
			              <div className="product-details-inner">
			                ...
			                <p>Beautiful heavily wooded parcel with great topography in the heart of Hunting Valley. This location is conveniently located on the western part of Hunting Valley, close to everything including highway access, shopping, restaurants. Abuts Squire Valley Farms. Public water available for tie-in at street. </p>
			              </div>
			              <div className="product-meta-bottom">
			                <span className="price">$ 80,650.00</span>
			                <span>For sale</span>
