			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Rhomes estate </p>
			                    </div>
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Looot estate </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Achara Layout </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Anambra roller estate </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />New Haven </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Independence Layout </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Enugu Ugwuaji </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
			              ...
			              <div className="thumb">
			                ...
			                <div className="product-wrap-details">
			                  <div className="media">
			                    ...
			                    <div className="media-body">
			                      <h6><Link to="/property-details">Victor Johnson</Link></h6>
			                      <p><img src={publicUrl+"assets/img/icon/location-alt.png"} alt="img" />Enugu Sentinery estate </p>
			                    </div>
			                    <a className="fav-btn float-right" href="#"><i className="far fa-heart" /></a>
			                  </div>
			                </div> 
