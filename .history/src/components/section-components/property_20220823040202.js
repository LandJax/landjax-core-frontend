			          ...
			          <div className="col-lg-4 col-md-6">
			            <div className="single-product-wrap style-bottom">
			              ...
			              <div className="product-details-inner">
			                ...
			                <p>ruly distinctive homes are constructed with great care as to how they sit on their grounds and
								 this uniquely inviting property is absolutely no exception. The property backs up to approximately 900 acres of The West Woods Geauga Park System providing amazing views during every season.</p>
			              </div>
			              <div className="product-meta-bottom">
			                <span className="price">$ 80,650.00</span>
			                <span>For sale</span>
