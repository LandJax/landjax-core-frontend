			          ...
			          <div className="col-lg-4 col-md-6">
			            <div className="single-product-wrap style-bottom">
			              ...
			              <div className="product-details-inner">
			                ...
			                <p>Beautiful 5 bedroom, 3 bathroom, ranch-style home in the Meadows at Wellington community awaits its new owners. As you enter, you will be impressed by an open concept floorplan that lets natural light settle in all the right places.</p>
			              </div>
