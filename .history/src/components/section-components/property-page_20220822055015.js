			          ...
			          <div className="col-md-6">
			            <div className="single-product-wrap style-2">
			              ...
			              <div className="product-details-inner">
			                ...
			                <p>Aimart Realtors constantly works towards ensuring that the housing sector is open and works for all not just as a means to obtain shelter but also for security and as an investment tool.
