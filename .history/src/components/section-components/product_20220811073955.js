			          ...
			          <div className="product-wrap-details">
			            <div className="media">
			              <div className="author">
			                <img src={publicUrl+"assets/images/4.jpg"} alt="img" />                                    
			              </div>
			              <div className="media-body">
			                <h6><Link to="/property">Owner Name</Link></h6>
			                <p><img src={publicUrl+"assets/images/1.jpg"} alt="img" />New York real estate </p>
			              </div>
			            ...
			            <div className="product-meta">
			              ...
			              <div className="float-right d-inline-block">
			                <ul>
			                  <li><img src={publicUrl+"assets/images/icon/triangle.png"} alt="img" />2</li>
