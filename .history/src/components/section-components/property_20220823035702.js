			          ...
			          <div className="col-lg-4 col-md-6">
			            <div className="single-product-wrap style-bottom">
			              ...
			              <div className="product-details-inner">
			                ...
			                <p>eacefully nestled in the mountains of Evergreen Colorado, and with spectacular views, this 0.99 acre lot will be your playground year round! Upon entering.</p>
			              </div>
			              <div className="product-meta-bottom">
			                <span className="price">$ 80,650.00</span>
			                <span>For sale</span>
