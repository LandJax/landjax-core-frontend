			          ...
			          <div className="col-lg-4 col-md-6">
			            <div className="single-product-wrap style-bottom">
			              ...
			              <div className="product-details-inner">
			                ...
			                <p>Mid-century brick ranch home on a large lot! The main floor has attractive and easy to care for vinyl plank flooring. Stainless steel appliances and abundant counter prep space and cabinets can be found in the kitchen and the updated.</p>
			              </div>
			              <div className="product-meta-bottom">
			                <span className="price">$ 80,650.00</span>
			                <span>For sale</span>
