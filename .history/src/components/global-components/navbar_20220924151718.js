			  ...
			  <nav className="navbar navbar-expand-lg">
			    <div className="container nav-container">
			      ...
			      <div className="nav-right-part nav-right-part-desktop">
			        <ul>
			          <li><a className="search" href="#"><i className="fa fa-search" /></a></li>
			          <li><Link className="btn btn-base" to="/add-property"><span className="btn-icon"><i className="fa fa-plus" /></span> <span className="btn-text">SELL PROPERTY PROPERTY</span></Link></li>
			        </ul>
			      </div>
			    </div>
			  </nav>
