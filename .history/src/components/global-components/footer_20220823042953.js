								...
								<div className="widget widget_about">
									...
									<div className="details">
										<p>Founded in 1976 to provide independent brokerages with a powerful marketing and referral program for luxury listings, 
											the Landjax was designed to connect the finest independent real estate companies to the most prestigious clientele in the world. LandJaxc LLC is a subsidiary of Realogy Holdings Corp. (NYSE: RLGY),
